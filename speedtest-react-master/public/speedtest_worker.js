...
var settings = {
	...
	url_dl: "http://localhost:9000//testAPI/garbage", // path to a large file or garbage.php, used for download test. must be relative to this js file
	url_ul: "http://localhost:9000/testAPI/empty", // path to an empty file, used for upload test. must be relative to this js file
	url_ping: "http://localhost:9000/testAPI/empty", // path to an empty file, used for ping test. must be relative to this js file
	url_getIp: "http://localhost:9000/testAPI/getIP", // path to getIP.php relative to this js file, or a similar thing that outputs the client's ip
